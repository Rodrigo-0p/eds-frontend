...
const url_buscar_um       = '/vt/vtpresar/buscar/unidadm'   ;

// LISTAR
const url_list_cab           = '/vt/vtpresar/listar/cabecera';
const url_list_det           = '/vt/vtpresar/listar/detalle';
const url_buscar_nro_compr   = '/vt/vtpresar/cab/';
const url_buscar_nro_orden   = '/vt/vtpresar/det/';
const url_abm                = '/vt/vtpresar';

// REPORTE
const url_reporte            = '/vt/vtpresar/reporte/vtpresup';
