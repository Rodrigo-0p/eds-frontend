const columnDet = [
  ...
  { data: 'DESC_SUBCLIENTE'     , title: 'Descripcion'    , width : 120 , className:'htRight' , readOnly:true}, 
  { data: 'SIGLAS'              , title: 'Sigla'          , width : 40  , className:'htRight' , readOnly:true ,  filter:false }, 
  { data: 'TOTAL'               , title: 'Saldo'          , width : 60  , className:'htRight' , type:'numeric'  , readOnly:true      , format:{pattern: '0,0.000'}},
  { data: 'MONTO_A_COBRAR'      , title: 'Monto a Cobrar' , width : 60  , className:'htRight' , type:'numeric'  , readOnly:false     , format:{pattern: '0,0.000'} , validaAllExterno:true},
